...
class OCRProcessor:
    ...
    def extract_student_answers(self, image_data):
        ...
        prompt = """
        Look at this student answer sheet and find which options the student marked.
        
        Find clear marks like: checkmarks ✓, diagonal lines /, circles around options, or bold marks.
        Be very careful - only include options that are clearly marked.
        
        For each question:
        1. See what options exist (A,B,C,D or A,B,C,D,E etc.)
        2. Look for clear marks on those options only
        3. Don't include options that don't exist in the question
        4. If unsure about a mark, don't include it
        
        Also look for roll number and section.
