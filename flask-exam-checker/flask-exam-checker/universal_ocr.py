...
class OCRProcessor:
    ...
    def extract_teacher_answers(self, image_data):
        ...
        Find the marking scheme (equal marks or weightage like a=2, b=3).
        
        Adapt to whatever format you see - any question numbering, any option types, any marks format.
        
        Return JSON with all questions you find:
        {
            "total_questions": N,
            "answers": [
                {
                    ...
                    "marks": total_marks_or_calculated,
    ...
    def extract_student_answers(self, image_data):
        ...
        Find any clear marks: checkmarks, lines, circles, bold marks.
        Only include options that are clearly marked.
        Adapt to any question format and option types you see.
